...
- 阶段 5 切片进度（PRD 见根目录 PRD_阶段5 文档）：S0 工具链 ✅ / F2-S 简历打分服务端 ✅（迁移 `20260901000000_add_ai_match_score` 已生成待人工 apply）/ F2-C 前端 ✅ / F1-S ✅ / F1-C ✅ / F3-S ✅（迁移 `20260902000000_add_interview_question_outline` 已生成待人工 apply）/ F3-C ✅ / F5-S ⬜ / F5-C ⬜ / F4-S1 ⬜ / F4-S2 ⬜ / F4-C ⬜ / M6 ⬜
